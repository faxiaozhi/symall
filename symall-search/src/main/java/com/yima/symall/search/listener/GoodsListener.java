package com.yima.symall.search.listener;

import com.yima.core.bean.Resp;
import com.yima.symall.pms.entity.*;
import com.yima.symall.search.feign.SymallPmsClient;
import com.yima.symall.search.feign.SymallWmsClient;
import com.yima.symall.search.pojo.Goods;
import com.yima.symall.search.pojo.SearchAttr;
import com.yima.symall.search.repository.GoodsRepository;
...
public class GoodsListener {
    ...
    @Autowired
    private SymallPmsClient pmsClient;

    @Autowired
    private SymallWmsClient wmsClient;
